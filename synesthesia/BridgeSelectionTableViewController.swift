...
class BridgeSelectionTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = bridges![indexPath.row].friendlyName
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let dest = segue.destination as? BridgePushLinkViewController {
            dest.bridge = bridges![self.tableView.indexPathForSelectedRow!.row]
        }
    }
